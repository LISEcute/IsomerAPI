...
int main(int argc, char *argv[])
{
    ...
    palette.setColor(QPalette::Window, QColor(240, 245, 240));
    palette.setColor(QPalette::WindowText, QColor(0, 0, 0));
    palette.setColor(QPalette::Button, QColor(235, 240, 235));
    palette.setColor(QPalette::ButtonText, QColor(0, 10, 0));
    ...
    palette.setColor(QPalette::Dark, QColor(159, 159, 159));
